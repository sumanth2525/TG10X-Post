...
3. The workflow file is `.github/workflows/tg10x-daily.yml`. Edit the `cron` lines for your time (**GitHub uses UTC only**). Includes **7:30 AM EST** (`30 12 * * *`), **7:33 / 7:35 / 8:00 PM EST** (`33 0`, `35 0`, `0 1` UTC). In **EDT**, adjust per comments in the YAML (e.g. **8 PM EDT** → `0 0 * * *`).
